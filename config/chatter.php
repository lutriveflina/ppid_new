...
return [
    ...
    */
    ...
    'middleware' => [
        'global'     => ['web', 'auth', 'activity'],
        'home'       => ['web', 'auth', 'activity'],
        'discussion' => [
            'index'   => ['web', 'auth', 'activity'],
            'show'    => ['web', 'auth', 'activity'],
            'create'  => ['web', 'auth', 'activity'],
            'store'   => ['web', 'auth', 'activity'],
            'destroy' => ['web', 'auth', 'activity'],
            'edit'    => ['web', 'auth', 'activity'],
            'update'  => ['web', 'auth', 'activity'],
        ],
        'post' => [
            'index'   => ['web', 'auth', 'activity'],
            'show'    => ['web', 'auth', 'activity'],
