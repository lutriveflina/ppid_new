                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form method="POST" action="{{ route('register') }}">
                                                    ...
                                                    <div class="form-label-group">
                                                        <?=captcha_img();?>
                                                        <input type="text" id="captcha" class="form-control @error('captcha') is-invalid @enderror" name="captcha" placeholder="Masukkan Captcha" required autocomplete="captcha">
