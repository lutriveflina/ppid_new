    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="sec_title text-center mb_70 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                ...
                <!-- <h6 class="text-warning text-center">Silahkan klik tombol <b class="badge badge-info" title="Download"><i class="fas fa-download"></i></b> untuk melakukan download dokumen</h6> -->
                <!-- @else
                <h4 class="text-warning text-center">Silahkan <a class="badge badge-warning" href="{{route('login')}}">Login</a> terlebih dahulu untuk melakukan download dokumen</h4>
                @endif -->
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body mb-5">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="sakip">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                                <th>JUDUL</th>
...
@push('scripts')
    <script>
        var table = $('#sakip').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('informasipublik/sakip') }}",
            columns: [
