    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="sec_title text-center mb_70 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                ...
                <h2 class="text-white text-center"><b>Regulasi Keterbukaan Informasi Publik</b></h2>
                @if(Auth::check())
                ...
                @else
                <h6 class="text-warning text-center">Silahkan <a class="badge badge-warning" href="{{route('login')}}">Login</a> terlebih dahulu untuk melakukan download dokumen jenis Informasi Berkala</h6>
                @endif
            </div>
