    ...
    <section class="breadcrumb_area">
        ...
        <div class="container">
            <div class="sec_title text-center mb_70 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                ...
                <h2 class="text-white text-center"><b>Transparansi</b></h2>
                @if(Auth::check())
                        ...
                        <div class="card-content">
                            <div class="card-body mb-5">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="transparansi">
                                        <thead>
                                            <tr>
                                                <th>NO</th>
                                                <th>JUDUL</th>
...
@push('scripts')
    <script>
        var table = $('#transparansi').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ url('transparansi') }}",
            columns: [
